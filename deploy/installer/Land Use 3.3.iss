...
Source: {#BuildDir}\Landis.Extension.LandUse-v3.3.dll; DestDir: {#ExtDir}; Flags: ignoreversion
...
[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Land Use Change v3.3"" "; WorkingDir: {#LandisPlugInDir}
